...
def selects_the_category_names_and_pledge_amounts_of_all_pledges_in_the_music_category
  "SELECT projects.category, pledges.amount FROM projects INNER JOIN pledges ON project_id = pledges.project_id GROUP BY projects.category WHERE projects.category = 'music';"
end
